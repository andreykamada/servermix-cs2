...
$agentsFile = file_exists('src/data/agents_en.json')
    ? 'src/data/agents_en.json'
    : 'src/data/agents.json';

$agents = json_decode(file_get_contents($agentsFile));
...
if (Path(1) && in_array(strtoupper(Path(1)), ['TR', 'CT'])) {
